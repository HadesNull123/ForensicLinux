...
if __name__ == "__main__":
    main()
    # for i, line in enumerate(io.open('E:\\Forensic\\LogServer\\54.251.118.137\\AdministratorsController.php', 'r+', encoding="utf-8")):
    #     for match in re.finditer(regex_url, line):
    #         print(str('Found on line %s: %s' % (i+1, match.group())))
